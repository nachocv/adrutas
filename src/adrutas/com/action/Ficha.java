...
public class Ficha extends ActionSupport {
    private static final long serialVersionUID = -3499169120164909661L;
...
//    private Object item = "{}";
    ...
    public Map<Integer, Map<String, Object>> getFichas() {
        return fichas;
    }
...
//    }
    ...
    public String execute() throws Exception {
        ...
        anyo = anyo==null? year.toString(): anyo;
        if ("Grabar".equals(grabar)) {
            ...
            bean.put("nacimiento", nacimiento.isEmpty()? null: nacimiento);
            ...
            bean.put("adulto", "on".equals(adulto));
            bean.put("club", club);
            bean.put("fp", fp);
            bean.put("regalo", "on".equals(regalo));
            adrutas.com.dao.Ficha.put15(bean);
        }
        if ("Cancelar".equals(cancel)) {
            ...
            telefonos = adrutas.com.dao.Persona.getJsonTelefonos(id_persona).toString();
            emails = adrutas.com.dao.Persona.getJsonEmails(id_persona).toString();
            Map<String, Object> ficha = adrutas.com.dao.Ficha.getId_persona(map);
            fichas.put((integer = (Integer) ficha.get("anyo")), ficha);
            ficha.put("actual", Constante.FICHA_YEAR==integer);
            ficha.put("open", Constante.anyosOpen.get(integer));
            ficha.put("licencias", Licencia.get(integer));
            ficha.put("essocio", ((BigDecimal) ficha.get("importecuota")).signum()==0? "": " checked=\"checked\"");
            ficha.put("adulto", (Boolean) ficha.get("adulto")? " checked=\"checked\"": "");
