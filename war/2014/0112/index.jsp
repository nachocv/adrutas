...
<%@ include file="/2014/federacion.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2014/0112/excursiones.jsp"%>

<%@ include file="/2014/0112/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
