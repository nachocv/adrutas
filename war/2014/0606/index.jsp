...
<%@ include file="/2014/bienvenida.jsp"%>
              ...
              <td>
<%@ include file="/2014/aviso5.jsp"%>
<%@ include file="/2014/0606/proxima.jsp"%>
...
<%@ include file="/txt/noticias2.txt"%>
            ...
            <tr class="top">
              <td colspan="3">
<%@ include file="/2014/curso_gps_movil.jsp"%>
              </td>
            </tr>
          </table>
				</td>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2014/0606/excursiones.jsp"%>

<%@ include file="/2014/0606/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
