...
<%@ include file="/2014/bienvenida.jsp"%>
              ...
              <td>
<%@ include file="/2014/aviso6.jsp"%>
<%@ include file="/2014/0622/proxima.jsp"%>
...
<%@ include file="/txt/noticias2.txt"%>
      ...
      <tr>
        <td class="td_contenedor centrado" style="text-align: center;">
<%@ include file="/2014/0622/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
