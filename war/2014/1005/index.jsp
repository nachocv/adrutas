...
<%@ include file="/2014/bienvenida.jsp"%>
              ...
              <td>
<%@ include file="/2014/aviso7.jsp"%>
<%@ include file="/2014/1005/proxima.jsp"%>
<%@ include file="/txt/ventajas_socio.txt"%>
              </td>
              <td>
<%@ include file="/2014/aviso8.jsp"%>
...
<%@ include file="/2014/federacion.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2014/1005/excursiones.jsp"%>

<%@ include file="/2014/1005/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
