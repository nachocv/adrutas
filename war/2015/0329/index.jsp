...
<body>
    ...
    <table class="tabla_contenedor art-article">
          ...
          <table>
            <tr class="top">
              <td>
<%@ include file="/2015/aviso5.jsp"%>
<%@ include file="/2015/aviso4.jsp"%>
...
<%@ include file="/2015/0329/proxima.jsp"%>
...
<%@ include file="/2015/seguros/fmm/federacion.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2015/0329/excursiones.jsp"%>

<%@ include file="/2015/0329/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
