...
<body>
    ...
    <table class="tabla_contenedor art-article">
          ...
          <table>
            <tr class="top">
              <td>
<%@ include file="/2015/05/aviso1.jsp"%>
<%@ include file="/2014/aviso9.jsp"%>
<%@ include file="/2014/aviso.jsp"%>
<%@ include file="/2015/bienvenida.jsp"%>
              </td>
              <td>
<%@ include file="/2015/aviso7.jsp"%>
<%@ include file="/2015/0523/proxima.jsp"%>
...
<%@ include file="/2015/seguros/fmm/federacion.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2015/0523/excursiones.jsp"%>

<%@ include file="/2015/0523/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
