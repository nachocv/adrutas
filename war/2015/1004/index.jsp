...
<body>
    ...
    <table class="tabla_contenedor art-article">
          ...
          <table>
            <tr class="top">
              <td>
<%@ include file="/2015/09/aviso1.jsp"%>
<%@ include file="/2014/aviso9.jsp"%>
<%@ include file="/2014/aviso.jsp"%>
<%@ include file="/2015/bienvenida.jsp"%>
              </td>
              <td>
<%@ include file="/2015/10/aviso1.jsp"%>
<%@ include file="/2015/1004/proxima.jsp"%>
...
<%@ include file="/2015/seguros/fmm/federacion.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2015/1004/excursiones.jsp"%>

<%@ include file="/2015/1004/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
