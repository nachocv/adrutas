...
<%@ include file="/2015/11/aviso1.jsp"%>
<%@ include file="/2016/bienvenida.jsp"%>
              </td>
              <td>
<%@ include file="/2015/12/loteria.jsp"%>
<%@ include file="/2015/1205/proxima.jsp"%>
...
<%@ include file="/txt/noticias2.txt"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2015/1205/excursiones.jsp"%>

<%@ include file="/2015/1205/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
