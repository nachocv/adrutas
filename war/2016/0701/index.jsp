...
<body>
    ...
    <table class="tabla_contenedor art-article">
          ...
          <table>
            <tr class="top">
              <td>
<%@ include file="/2016/05/aviso1.jsp"%>
...
<%@ include file="/2015/aviso10.jsp"%>
              ...
              <td>
<%@ include file="/2016/0701/proxima.jsp"%>
<%@ include file="/2016/aviso1.jsp"%>
<%@ include file="/2016/ventajas_socio.jsp"%>
              </td>
              <td>
<%@ include file="/2016/0701/aviso1.jsp"%>
<%@ include file="/2016/0626/aviso1.jsp"%>
...
<%@ include file="/2016/noticias1.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2016/0701/excursiones.jsp"%>
<%@ include file="/2016/0701/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
