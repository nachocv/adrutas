...
<div class="caja_m">
  ...
  <%if ((Boolean) request.getAttribute("presentarMensaje")) {%>
    ...
    <%}%>
  <%}%>
    <br/>Domingo 15 de enero a las 08:00
    <br/>Cuerda la Parada y Cerro Yelmo
  </h3>
  <article>
    ...
    <br/><br/><script type='text/javascript' src='http://www.aemet.es/es/eltiempo/prediccion/municipios/launchwidget/pelayos-de-la-presa-id28109?w=g4p01110001ohmffffffw460z190x4f86d9t95b6e9r1s8n2'></script><noscript><a target='_blank' style='font-weight: bold;font-size: 1.20em;' href='http://www.aemet.es/es/eltiempo/prediccion/municipios/pelayos-de-la-presa-id28109'>El Tiempo. Consulte la predicción de la AEMET para Pelayos de la Presa</a></noscript>
  </article>
</div>
