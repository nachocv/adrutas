...
<body>
    ...
    <table class="tabla_contenedor art-article">
          ...
          <table>
            <tr class="top">
              <td>
<%@ include file="/2017/01/aviso2.jsp"%>
<%@ include file="/2016/apunte.jsp"%>
<%@ include file="/2017/bienvenida.jsp"%>
              </td>
              <td>
<%@ include file="/2017/0217/aviso1.jsp"%>
<%@ include file="/2017/0212/proxima.jsp"%>
...
<%@ include file="/2016/noticias2.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2017/0212/excursiones.jsp"%>
<%@ include file="/2017/0212/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
