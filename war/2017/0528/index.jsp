...
<body>
    ...
    <table class="tabla_contenedor art-article">
          ...
          <table>
            <tr class="top">
              <td>
<%@ include file="/2017/0611/aviso1.jsp"%>
<%@ include file="/2017/bienvenida.jsp"%>
              </td>
              <td>
<%@ include file="/2017/0616/aviso1.jsp"%>
<%@ include file="/2017/0528/proxima.jsp"%>
...
<%@ include file="/2016/noticias2.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2017/0528/excursiones.jsp"%>
<%@ include file="/2017/0528/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
