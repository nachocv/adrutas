...
<%@ include file="/2018/bienvenida.jsp"%>
              ...
              <td>
<%@ include file="/2018/0427/aviso2.jsp"%>
<%@ include file="/2018/0422/proxima.jsp"%>
<%@ include file="/2016/ventajas_socio.jsp"%>
              </td>
              <td>
<%@ include file="/2018/03/aviso1.jsp"%>
...
<%@ include file="/2016/noticias2.jsp"%>
      ...
      <tr>
        <td class="td_contenedor">
<%@ include file="/2018/0422/excursiones.jsp"%>
<%@ include file="/2018/0422/salidas.jsp"%>
        </td>
      </tr>
			<tr>
				<td class="td_contenedor">
